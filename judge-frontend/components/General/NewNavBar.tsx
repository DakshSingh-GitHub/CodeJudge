    ...
    return (
        ...
        >
            <div className="mx-auto flex max-w-[1600px] justify-center">
                <div className="relative w-[90vw] max-w-[90vw] rounded-full border border-slate-700/60 bg-[linear-gradient(135deg,rgba(8,12,20,0.98),rgba(15,23,42,0.9))] px-4 py-3 shadow-[0_22px_60px_rgba(2,6,23,0.5)] backdrop-blur-3xl before:pointer-events-none before:absolute before:inset-[1px] before:rounded-full before:border before:border-slate-600/40 before:content-['']">
                    <div className="pointer-events-none absolute inset-x-[22%] top-0 h-px bg-gradient-to-r from-transparent via-slate-500/20 to-transparent" />
                        ...
                        <div className="flex items-center gap-2 md:gap-3">
                            {isCodeAnalysis && (
                                <button
                                    ...
                                    className="flex items-center gap-2 rounded-full border border-slate-600/50 bg-slate-900/50 px-4 py-2.5 text-xs font-medium text-slate-200 transition-all duration-200 hover:border-slate-500/60 hover:bg-slate-800/70 hover:text-white hover:shadow-[0_14px_28px_rgba(2,6,23,0.28)]"
                            ...
                            {(isCodeJudge || isCodeIDE) && (
                                <button
                                    ...
                                    className="hidden items-center gap-2 rounded-full border border-slate-600/50 bg-slate-900/50 px-4 py-2.5 text-xs font-medium text-slate-200 transition-all duration-200 hover:border-slate-500/60 hover:bg-slate-800/70 hover:text-white hover:shadow-[0_14px_28px_rgba(2,6,23,0.28)] lg:flex"
                            ...
                            <div className="relative" ref={profileRef}>
                                <button
                                    ...
                                    className="group flex items-center gap-3 rounded-full border border-slate-600/50 bg-slate-900/50 py-1.5 pl-1.5 pr-3 text-slate-100 transition-all duration-200 hover:border-slate-500/60 hover:bg-slate-800/70 hover:shadow-[0_14px_28px_rgba(2,6,23,0.28)] active:scale-95"
                                    title="Profile"
                                    aria-label="Profile"
                                >
