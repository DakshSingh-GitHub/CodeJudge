...
export default function ResultModal({ result, onClose }: ResultModalProps) {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center px-4 sm:px-6">
            ...
            {/* Modal Content */}
            <div className="relative w-full max-w-4xl max-h-[90vh] bg-white dark:bg-gray-900 rounded-2xl shadow-2xl overflow-hidden flex flex-col border border-white/20 dark:border-gray-700/60 animate-in fade-in zoom-in-95 duration-200">
